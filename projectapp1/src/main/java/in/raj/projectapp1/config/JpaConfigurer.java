package in.raj.projectapp1.config;
...
import in.raj.projectapp1.support.jpa.CustomRepositoryFactoryBean;
import in.raj.projectapp1.support.jpa.SpringSecurityAuditorAware;
...
@Configuration
@EnableJpaRepositories(basePackages = "in.raj.projectapp1.web.repository", repositoryFactoryBeanClass = CustomRepositoryFactoryBean.class)
// @EnableJpaRepositories(basePackages =
// "in.raj.projectapp1.web.repository",
